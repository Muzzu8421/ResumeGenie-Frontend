      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div {...fadeInUp} className="text-center mb-12 sm:mb-16">
          ...
          <p className="font-inter text-base sm:text-lg md:text-xl text-gray-600 max-w-3xl mx-auto">
            See how our AI-powered platform transforms the resume creation
            experience
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 mb-16 sm:mb-20">
          ...
          >
            ...
            <h3 className="font-playfair text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              The Old Way
            </h3>
            <p className="font-inter text-base sm:text-lg text-gray-600 mb-8">
              Struggling with traditional resume building
            </p>
              ...
              {[
                {
                  ...
                  desc: "Endless formatting and guessing what employers want",
                },
                {
                  title: "ATS Black Hole",
                  desc: "90% of resumes never reach human eyes due to ATS filters",
                },
                {
                  title: "Generic Templates",
                  desc: "Cookie-cutter designs that don&apos;t showcase your uniqueness",
                },
                {
                  title: "No Feedback Loop",
                  desc:
                    "Apply blindly without knowing what&apos;s working or not",
                },
                {
                  title: "Missed Opportunities",
                  desc: "Lose out on dream jobs due to poor resume quality",
                },
              ].map((item, idx) => (
                <li
                  key={idx}
                  className="font-inter text-base text-gray-700 flex items-start gap-4"
                >
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <ul className="space-y-5">
                {[
                  {
                    title: "60-Second Optimization",
                    desc: "AI analyzes and improves your resume instantly",
                  },
                  {
                    title: "ATS-Optimized Format",
                    desc:
                      "Guaranteed to pass automated screening systems",
                  },
                  {
                    title: "Industry-Specific Insights",
                    desc: "Tailored recommendations based on your field",
                  },
                  {
                    title: "Real-Time Scoring",
                    desc: "Watch your resume improve with instant feedback",
                  },
        ...
        <motion.div
          {...fadeInUp}
          className="bg-white rounded-3xl shadow-[0_4px_40px_rgba(0,0,0,0.08)] p-10 sm:p-12 md:p-14 text-center border border-gray-100"
        >
          <h3 className="font-playfair text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-4">
            Ready to Transform Your Resume?
          </h3>
          <p className="font-inter text-base sm:text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
            Join over 50,000 successful job seekers who&apos;ve used ResumeGenie
            to land their dream positions
          </p>
          ...
          <p className="font-inter text-xs sm:text-sm text-gray-500 mt-4">
