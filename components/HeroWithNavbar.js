  ...
  return (
    <>
      ...
      <section className="relative min-h-screen bg-gradient-to-br from-[#784592] via-[#4C3178] to-[#21225F] overflow-hidden">
        {/* Navbar */}
        <nav
          className={`absolute top-0 left-0 right-0 z-50 w-full px-4 sm:px-6 lg:px-8 sm:py-2 transition-all duration-700 ${
        ...
        >
          <div className="max-w-7xl mx-auto flex items-center justify-between">
            <div className="flex items-center group cursor-pointer">
              ...
              <span className="font-inter text-gray-50 font-semibold text-base sm:text-lg lg:text-xl tracking-tight">
                ResumeGenie
              </span>
            </div>
            ...
            <div className="font-inter hidden md:flex items-center gap-3 lg:gap-6 xl:gap-8">
              <a
                href="#home"
                className="text-gray-50 font-medium hover:text-gray-100 transition-colors text-sm lg:text-base relative group"
              >
                Home
            ...
            <button
              ...
              className="md:hidden text-gray-50 p-2 hover:bg-white/10 rounded-lg transition-all duration-300"
            ...
            >
              <div className="relative w-6 h-6">
                ...
                ></span>
                <span
                  className={`absolute top-1/2 left-0 w-6 h-0.5 bg-current transform -translate-y-1/2 transition-all duration-300 ${
                    isMenuOpen ? "opacity-0" : ""
                  }`}
                ></span>
                <span
                  className={`absolute bottom-1 left-0 w-6 h-0.5 bg-current transform transition-all duration-300 ${
                    isMenuOpen ? "-rotate-45 -translate-y-2" : ""
                  }`}
                ></span>
              </div>
          ...
          <div
            className={`font-inter md:hidden mt-4 overflow-hidden transition-all duration-500 ${
          ...
          >
            <div className="pb-4 space-y-3 bg-[#784592]/90 backdrop-blur-md rounded-2xl p-4 shadow-xl">
              <a
                href="#home"
                className="block text-gray-50 font-medium hover:text-gray-100 py-2 hover:pl-2 transition-all duration-300"
              >
                Home
              </a>
              <a
              ...
              <Link href="/Dashboard">
                <button className="w-full bg-gray-50 text-[#784592] px-6 py-2.5 rounded-full font-semibold shadow-lg hover:shadow-xl hover:bg-gray-100 transition-all duration-300 mt-2">
                  Get Started
                </button>
              </Link>
            </div>
        ...
        <div className="relative z-10">
          ...
          <div
            className={`max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 pt-24 sm:pt-28 lg:pt-32 pb-12 sm:pb-16 lg:pb-20 grid grid-cols-1 lg:grid-cols-2 gap-10 sm:gap-12 lg:gap-12 xl:gap-16 items-center min-h-screen transition-all duration-700 ${
          ...
          >
            ...
            <div className="flex flex-col justify-center space-y-4 sm:space-y-5 lg:space-y-6 xl:space-y-7 text-center lg:text-left order-2 lg:order-1">
              <h1
                className="flex flex-wrap gap-2 items-center justify-center lg:justify-start font-playfair text-gray-50 font-bold text-2xl sm:text-3xl md:text-4xl lg:text-[2.8rem] xl:text-[3.4rem] 2xl:text-6xl leading-[1.15] tracking-tight"
              >
                Boost Your
                <RotatingText
                  texts={[
              ...
              <p className="font-inter text-gray-100/95 text-sm sm:text-base lg:text-lg xl:text-xl leading-relaxed font-normal max-w-xl mx-auto lg:mx-0 px-2 sm:px-0">
                <TextType
                  text={[
                    "Revolutionize your job search experience. Our AI-driven platform analyzes, optimizes, and boosts your resume to open doors to your dream job.",
                  ]}
                  typingSpeed={75}
                  pauseDuration={1500}
                  showCursor={true}
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center lg:justify-start pt-2 sm:pt-3 px-2 sm:px-0">
                ...
                >
                  <button className="font-inter bg-transparent text-white font-semibold px-5 sm:px-7 lg:px-9 xl:px-12 py-2.5 sm:py-3 lg:py-3.5 xl:py-4 rounded-full transition-all duration-300 hover:scale-105 text-sm sm:text-base lg:text-lg w-full hover:bg-white/5">
                    Watch Demo
                  </button>
                </ElectricBorder>
              </div>
            ...
            <div className="flex items-center justify-center relative order-1 lg:order-2 py-8 sm:py-10 lg:py-0">
              <div
                className={`absolute inset-0 rounded-3xl bg-gradient-to-r from-purple-500 via-pink-500 to-indigo-500 ${
                  !isMobile ? "animate-gradient-x" : ""
                } opacity-60 blur-3xl`}
              ></div>
              {!isMobile && (
                <div
                  className="absolute inset-0 rounded-3xl bg-gradient-to-br from-blue-400 via-purple-600 to-pink-500 animate-gradient-x opacity-40 blur-2xl"
                  style={{ animationDelay: "2s", animationDuration: "25s" }}
                ></div>
              )}
              <div
                className={`relative w-[260px] h-[360px] xs:w-[280px] xs:h-[390px] sm:w-[310px] sm:h-[435px] md:w-[350px] md:h-[490px] lg:w-[320px] lg:h-[450px] xl:w-[370px] xl:h-[520px] 2xl:w-[400px] 2xl:h-[560px] ${
